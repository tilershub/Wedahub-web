...
export const services: ServiceCategory[] = [
  ...
  },
  {
    ...
    slug: 'masonry',
    icon: '🧱',
    description: 'Brickwork, block work, plastering and stone wall construction',
  ...
  },
  {
    ...
    slug: 'tiling',
    icon: '⬜',
    description: 'Floor and wall tiling, grouting, and tile installation',
  ...
  },
  {
    ...
    slug: 'glass-work',
    icon: '🪟',
    description: 'Glass partitions, windows, mirrors and tempered glass fitting',
  ...
  },
  {
    ...
    slug: 'ceiling',
    icon: '🏢',
    description: 'Gypsum ceilings, false ceilings, panel installation and repairs',
  ...
  },
  {
    ...
    icon: '🗄️',
    description: 'Custom pantry cupboards, kitchen storage and cabinet installation',
    gradient: 'from-amber-50 to-lime-50',
  },
  {
